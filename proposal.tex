...
\begin{enumerate}
  ...
  \end{enumerate}
  \item Finally, we formulate the main result --- stable (w.r.t. interleaving distances) homological Quillen-McCord theorem. We adapt a proof given in ({\cite{Bar11}}) using developed apparatus and sketch the proof here.
\end{enumerate}
