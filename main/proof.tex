...
\begin{theorem} \textbf{Approximate Quillen-McCord theorem, draft statement}\\
  ...
  Then if $\forall y=(\ldots,y_i,\ldots) \in Y\;\mathcal{B}(f^{-1}(Y_{\leqslant y}))$ is $\varepsilon$-acyclic over $R$, $\mathcal{B}f$ induces $e$-interleavings of all homology modules over $R$ on $BX$ and $BY$.\\
\end{theorem}
...
\begin{theorem} \textbf{Approximate Quillen-McCord theorem, final statement}\\
  ...
  Then if $\forall y=(\ldots,y_i,\ldots) \in Y\;\mathcal{B}(f^{-1}(Y_{\leqslant y}))$ is $\varepsilon$-acyclic over $R$, $\mathcal{B}f$ induces $4m\varepsilon$-interleavings of all homology modules over $R$ on $BX$ and $BY$.\\
\end{theorem}
