...
\begin{definition}
  ...
  We shall refer to this general pseudometric as to approximation distance, however we do not give another examples expect for interleaving distance.
\end{definition}
...
\begin{lemma}
  ...
  \begin{itemize}
    ...
    \item If $M \stackrel{\varepsilon_1}{\sim} 0$ then $L \stackrel{2\varepsilon}{\sim} N$. {\cite[Proposition 4.1]{GS16}}
    \item If $N \stackrel{\varepsilon_1}{\sim} 0$ then $M \stackrel{2\varepsilon}{\sim} L$. {\cite[Proposition 4.1]{GS16}}
  \end{itemize}
\end{lemma}
