...
Consider $\mathcal{F}$ --- functor from $\mathcal{C}$ to $\mathcal{D}$. It naturally extends to functor between $Fun{I,\mathcal{C}}$ and $Fun{I,\mathcal{S}}$. Let $P$ be persistence poset.  Apparently $\mathcal{B}S$ is a persistence topological space.\\
