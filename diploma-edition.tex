...
\begin{definition}
  Let $f = (\ldots,f_n,\ldots)$ be a map of persistence posets $(X, \phi)$ and $(Y, \psi)$. Then mapping cylinders $M(f_j)$ form a persistence poset $M(f)$ with structure maps arising from the universal property of cocartesian squares and structure maps of $X$ and $Y$.\\
