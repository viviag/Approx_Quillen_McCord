...
\begin{definition}
  \define{Persistence simplicial set} is a family of simplicial sets $C_{0} \xrightarrow{f_0} C_{1} \xrightarrow{f_1} C_{2} \xrightarrow{f_2} \ldots$ where $f_i$ are the simplicial maps. We call the maps $f=(\ldots,f_i,\ldots)$ the \define{structure maps} of a persistence simplicial set.
\end{definition}
...
This obvious (geometric realization forgets orientation) proposition allowed Barmak to operate simplicial complexes instead of simplicial sets in his paper.\\
